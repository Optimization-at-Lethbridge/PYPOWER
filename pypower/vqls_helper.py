...
class VQLSSolver:
    ...
    def __initialize_params(self):
        ...
        return qml.numpy.tensor(np.random.uniform(low=0, high=2 * np.pi, size=params_shape), requires_grad=True)
...
if __name__ == '__main__':
    ...
    # Quantum solution
    # For 16 by 16
    vqls_solver = VQLSSolver(A, b, num_layers=11, conv_tol=1e-17, max_iterations=400)   #400 0.0627
