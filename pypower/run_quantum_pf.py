...
# from pypower.newtonpf_updated import newtonpf
...
def run_quantum_pf(casedata=None, ppopt=None, fname='', solvedcase=''):
    """Runs a power flow.
...
if __name__ == '__main__':
    ...
    ppopt = ppoption(PF_ALG=1, PF_DC=False, VERBOSE=2, IS_QUANTUM=True, QUANTUM_ALG=1)

    ppc = case3()
    run_quantum_pf(ppc, ppopt)
